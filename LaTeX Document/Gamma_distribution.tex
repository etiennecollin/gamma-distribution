...
\figurecenter{1}{Gamma_PDF.png}{Graph featuring the plot of the probability density function of a gamma distribution.}{fig:graph:gamma:pdf}
...
\subsubsection{Discovery \bigred{source}}
