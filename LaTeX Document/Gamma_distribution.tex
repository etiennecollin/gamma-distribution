...
$f(x)$ is the probability density function, then:\vspace*{-20pt}
\begin{equation}
...
\figurecenter{1}{Gamma_inflection.png}{Graph featuring the probability density function of four distinct gamma distributions.}{fig:graph:gamma:inflection}
