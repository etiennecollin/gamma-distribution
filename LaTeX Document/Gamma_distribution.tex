...
\figurecenter{1}{Beta_PDF.png}{Graph of the probability distribution function of a beta distribution for various parameterizations.}{fig:specialcases:beta:pdf}
...
\pagebreak
\subsubsection{Quotient of Gamma Random Variables}
Let's show how this distribution is related to the gamma distribution. Indeed, for $X\sim\G\text{amma}(\alpha, \lambda)$
and $Y\sim\G\text{amma}(\beta, \lambda)$, then $\frac{X}{X+Y}\sim\G\text{amma}(\alpha+\beta, \lambda)$. Let's prove it
