...
\subsection{The Normal Distribution \bigred{proof of CTL?}}
...
Here is the code used to generate the \nameref{subsec:gamma:pdf} graph of the gamma distribution:
\lstinputlisting[language=Python, caption={}, label=code:gamma:pdf]{_assets/Gamma_pdf.py}

\pagebreak
\subsection{Cumulative Distribution Function}
Here is the code used to generate the \nameref{subsec:gamma:cdf} graph of the gamma distribution:
