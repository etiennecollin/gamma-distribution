...
\subsection{Probability density function \bigred{Add graph}}\label{subsec:gamma:pdf}
...
\subsection{Cumulative distribution function \bigred{Add graph}}\label{subsec:gamma:cdf}
...
\pagebreak
\subsection{The Chi-Squared Distribution}\label{subsec:specialcase:chisquared}
...
\subsection{The Normal Distribution}\label{subsec:specialcase:normal}
...
\figurecenter{1}{Central_limit_theorem.png}{Graph showcasing the central limit theorem by comparing the probability density function graph of $\G\text{amma}(60, 1)$ to that of $\N(60, 60)$.}{fig:graph:ctl}
...
Here is the code used to generate the central limit theorem graph in \autoref{subsec:specialcase:normal}:
\lstinputlisting[language=Python, caption={}, label=code:gamma:ctl]{_assets/Central_limit_theorem.py}
