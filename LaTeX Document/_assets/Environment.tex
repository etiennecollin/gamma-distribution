...
\lstset{
	otherkeywords={self},
	emph={np, linspace, show, plt, xlim, ylim, hist, xlabel, ylabel, annotate, plot, title, sp, histogram_beta, histogram_gamma_sum, numpy, matplotlib, pyplot, scipy, gamma_distribution_cdf, gamma_distribution_pdf, array, math, itertools, rcParams, stats, beta, random, gamma},
