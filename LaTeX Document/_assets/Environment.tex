...
\lstset{
	otherkeywords={self},
	emph={np, linspace, central_limit_theorem, pdf, legend, norm, show, plt, xlim, ylim, hist, xlabel, ylabel, annotate, plot, title, sp, simulation_sum, simulation_quotient, numpy, matplotlib, pyplot, scipy, gamma_distribution_cdf, gamma_distribution_pdf, array, math, itertools, rcParams, stats, beta, random, gamma},
